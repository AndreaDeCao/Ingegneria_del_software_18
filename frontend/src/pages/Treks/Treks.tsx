...
function parseElevationGain(eg: Trek["elevationGain"]): number {
  if (eg == null) return 0;
  const n = Number(eg);
...
export default function Treks() {
  ...
  const sorted = [...filtered].sort((a, b) => {
    ...
    else if (sortBy === "elevationGain") r = parseElevationGain(a.elevationGain) - parseElevationGain(b.elevationGain);
